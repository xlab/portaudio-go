...
func NewHostApiInfoRef(ref *C.PaHostApiInfo) *HostApiInfo {
	...
	// runtime.SetFinalizer(obj, func(x *HostApiInfo) {
	// 	C.free(unsafe.Pointer(x.ref2fd9b1fc))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *HostApiInfo) PassRef() (ref *C.PaHostApiInfo, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
func (x *HostApiInfo) PassValue() (value C.PaHostApiInfo, allocs *cgoAllocMap) {
	if x == nil {
...
func (x *HostApiInfo) Deref() {
	...
	x.StructVersion = (int)(x.ref2fd9b1fc.structVersion)
	x.Type = (HostApiTypeId)(x.ref2fd9b1fc._type)
	x.Name = packPCharString(x.ref2fd9b1fc.name)
	x.DeviceCount = (int)(x.ref2fd9b1fc.deviceCount)
...
func NewHostErrorInfoRef(ref *C.PaHostErrorInfo) *HostErrorInfo {
	...
	obj.ref5c7a77d7 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *HostErrorInfo) {
	// 	C.free(unsafe.Pointer(x.ref5c7a77d7))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *HostErrorInfo) PassRef() (ref *C.PaHostErrorInfo, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *HostErrorInfo) PassValue() (value C.PaHostErrorInfo, allocs *cgoAllocMap) {
	if x == nil {
...
func NewDeviceInfoRef(ref *C.PaDeviceInfo) *DeviceInfo {
	...
	obj.refb60de337 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *DeviceInfo) {
	// 	C.free(unsafe.Pointer(x.refb60de337))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *DeviceInfo) PassRef() (ref *C.PaDeviceInfo, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *DeviceInfo) PassValue() (value C.PaDeviceInfo, allocs *cgoAllocMap) {
	if x == nil {
...
func (x *DeviceInfo) Deref() {
	...
	x.StructVersion = (int)(x.refb60de337.structVersion)
	x.Name = packPCharString(x.refb60de337.name)
	x.HostApi = (HostApiIndex)(x.refb60de337.hostApi)
	x.MaxInputChannels = (int)(x.refb60de337.maxInputChannels)
	x.MaxOutputChannels = (int)(x.refb60de337.maxOutputChannels)
...
func NewStreamParametersRef(ref *C.PaStreamParameters) *StreamParameters {
	...
	obj.reff0e97a84 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *StreamParameters) {
	// 	C.free(unsafe.Pointer(x.reff0e97a84))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *StreamParameters) PassRef() (ref *C.PaStreamParameters, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *StreamParameters) PassValue() (value C.PaStreamParameters, allocs *cgoAllocMap) {
	if x == nil {
...
func (x *StreamParameters) Deref() {
	...
	x.ChannelCount = (int)(x.reff0e97a84.channelCount)
...
func NewStreamCallbackTimeInfoRef(ref *C.PaStreamCallbackTimeInfo) *StreamCallbackTimeInfo {
	...
	obj.ref20d551f2 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *StreamCallbackTimeInfo) {
	// 	C.free(unsafe.Pointer(x.ref20d551f2))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *StreamCallbackTimeInfo) PassRef() (ref *C.PaStreamCallbackTimeInfo, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *StreamCallbackTimeInfo) PassValue() (value C.PaStreamCallbackTimeInfo, allocs *cgoAllocMap) {
	if x == nil {
...
func NewStreamInfoRef(ref *C.PaStreamInfo) *StreamInfo {
	...
	obj.reff696a1d0 = ref
	// enable this if the reference is unmanaged:
	// runtime.SetFinalizer(obj, func(x *StreamInfo) {
	// 	C.free(unsafe.Pointer(x.reff696a1d0))
	// })
	return obj
}

// PassRef returns a reference and creates new C object if no refernce yet.
func (x *StreamInfo) PassRef() (ref *C.PaStreamInfo, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
...
// PassValue creates a new C object if no refernce yet and returns the dereferenced value.
func (x *StreamInfo) PassValue() (value C.PaStreamInfo, allocs *cgoAllocMap) {
	if x == nil {
...
func (x *StreamInfo) Deref() {
	...
	x.StructVersion = (int)(x.reff696a1d0.structVersion)
