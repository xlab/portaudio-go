...
func streamCallback9F475638(cinput unsafe.Pointer, coutput unsafe.Pointer, cframeCount C.ulong, ctimeInfo *C.PaStreamCallbackTimeInfo, cstatusFlags C.PaStreamCallbackFlags, cuserData unsafe.Pointer) C.int {
	if streamCallback9F475638Func != nil {
		input9f475638 := (unsafe.Pointer)(unsafe.Pointer(cinput))
		output9f475638 := (unsafe.Pointer)(unsafe.Pointer(coutput))
		frameCount9f475638 := (uint)(cframeCount)
		timeInfo9f475638 := NewStreamCallbackTimeInfoRef(ctimeInfo)
		statusFlags9f475638 := (StreamCallbackFlags)(cstatusFlags)
		userData9f475638 := (unsafe.Pointer)(unsafe.Pointer(cuserData))
		ret9f475638 := streamCallback9F475638Func(input9f475638, output9f475638, frameCount9f475638, timeInfo9f475638, statusFlags9f475638, userData9f475638)
...
func streamFinishedCallbackEC352180(cuserData unsafe.Pointer) {
	if streamFinishedCallbackEC352180Func != nil {
		userDataec352180 := (unsafe.Pointer)(unsafe.Pointer(cuserData))
		streamFinishedCallbackEC352180Func(userDataec352180)
	}
	panic("callback func has not been set (race?)")
}
