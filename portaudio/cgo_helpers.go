...
func NewHostApiInfoRef(ref interface{}) *HostApiInfo {
	if ref == nil {
		return nil
	}
	...
	obj := new(HostApiInfo)
	obj.ref2fd9b1fc = (*C.PaHostApiInfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewHostErrorInfoRef(ref interface{}) *HostErrorInfo {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.ref5c7a77d7 = (*C.PaHostErrorInfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewDeviceInfoRef(ref interface{}) *DeviceInfo {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(DeviceInfo)
	obj.refb60de337 = (*C.PaDeviceInfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewStreamParametersRef(ref interface{}) *StreamParameters {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.reff0e97a84 = (*C.PaStreamParameters)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func NewStreamCallbackTimeInfoRef(ref interface{}) *StreamCallbackTimeInfo {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	obj.ref20d551f2 = (*C.PaStreamCallbackTimeInfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
...
func streamCallback615600DB(cinput unsafe.Pointer, coutput unsafe.Pointer, cframeCount C.ulong, ctimeInfo *C.PaStreamCallbackTimeInfo, cstatusFlags C.PaStreamCallbackFlags, cuserData unsafe.Pointer) C.int {
	if streamCallback615600DBFunc != nil {
		...
		timeInfo615600db := NewStreamCallbackTimeInfoRef(ctimeInfo)
...
func NewStreamInfoRef(ref interface{}) *StreamInfo {
	if ref == nil {
		return nil
	}
	type ifaceHeader struct {
	...
	hdr := (*(*ifaceHeader)(unsafe.Pointer(&ref)))
	obj := new(StreamInfo)
	obj.reff696a1d0 = (*C.PaStreamInfo)(unsafe.Pointer(hdr.Ref))
	return obj
}
